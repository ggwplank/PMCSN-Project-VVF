...
# colonne per lo standard simulator
COLUMNS_TO_SUM = [
    "mean_N_centre_hub", "mean_N_centre_red", "mean_N_centre_yellow",
    "mean_N_centre_green_squadra", "mean_N_centre_green_modulo"
]
...
def plot_sum_of_columns_from_multiple_csvs(csv_folder, output_folder, sample_rate=15, final_sample_rate=1, switch_batch=0,
